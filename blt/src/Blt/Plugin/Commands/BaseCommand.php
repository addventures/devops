...
use Add\Blt\Traits\IoTrait;
use Robo\Config\Config;
use Symfony\Component\Console\Question\Question;
use Add\Blt\Component\Filesystem\Filesystem;
...
class BaseCommand extends BltTasks {
   ...
   * The file system.
   *
   * @var \Add\Blt\Component\Filesystem\Filesystem
   */
  protected $fs;
  ...
  public function hookInit() {
    ...
    $this->projectName = "addventures/devops";
    $this->relPathDocroot = "docroot";

    $path_init_php = "{$this->pathSys}/project/devops/var/php/init.php";
    require_once "{$path_init_php}";
